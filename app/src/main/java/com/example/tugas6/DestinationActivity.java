...
public class DestinationActivity extends AppCompatActivity {
    ...
    String s1[], s2[],s3[];
    int images[] =
            {R.drawable.novelnoir,R.drawable.novelaromakarsa,R.drawable.noveltlm,R.drawable.logo};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
                                                           ...
                                                           NavigationView.OnNavigationItemSelectedListener() {
                                                               ...
                                                               public boolean onNavigationItemSelected(@NonNull
                                                                   ...
                                                                   if (id == R.id.nav_alarm){
                                                                       Intent a = new
                                                                               Intent(DestinationActivity.this,
                                                                               MainActivity.class);
                                                                       startActivity(a);
        ...
        NovelAdapter appAdapter = new
                NovelAdapter(this,s1,s2,s3,images);
